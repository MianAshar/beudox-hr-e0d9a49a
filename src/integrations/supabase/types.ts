    ...
    Tables: {
      ...
      project_evaluations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "project_evaluations_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
      ...
      project_rfi_questions: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_rfi_questions_answered_by_fkey"
            columns: ["answered_by"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "project_rfi_questions_asked_by_fkey"
            columns: ["asked_by"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "project_rfi_questions_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "project_rfi_questions_rfi_id_fkey"
            columns: ["rfi_id"]
            isOneToOne: false
      ...
      project_rfis: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_rfis_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
